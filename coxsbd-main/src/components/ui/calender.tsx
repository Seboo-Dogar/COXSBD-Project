  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-red-600 text-slate-50 hover:bg-red-600 hover:text-slate-50 focus:bg-red-600 focus:text-slate-50 dark:bg-red-600 dark:text-slate-50 dark:hover:bg-red-600 dark:hover:text-slate-50 dark:focus:bg-red-600 dark:focus:text-slate-50",
        day_today:
