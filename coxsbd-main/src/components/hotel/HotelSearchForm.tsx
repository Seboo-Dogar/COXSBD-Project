...
export default function HotelSearchForm() {
  ...
  return (
    <div className="bg-sky-50 p-4 rounded-md max-w-7xl mx-auto px-12 md:px-24 lg:px-12 xl:px-6 sm:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-10 gap-4 items-center justify-center">
      {/* City Search */}
      <div className="col-span-1 md:col-span-2 lg:col-span-3 relative">
        <div className="bg-white flex items-center border-2 border-sky-300 hover:border-red-600 text-lg rounded-md px-4 h-16 cursor-pointer min-w-0">
        ...
        {showCityDropdown && filteredCities.length > 0 && (
          <div className="absolute top-full left-0 w-full bg-white border border-gray-300 rounded-md shadow-md z-10 mt-1 max-h-40 overflow-y-auto">
      ...
      {/* Check-in */}
      <div className="col-span-1 md:col-span-1 lg:col-span-2 bg-white flex items-center border-2 border-sky-300 hover:border-red-600 text-lg rounded-md px-4 h-16 min-w-0">
        <Calendar className="w-5 h-5 mr-2 text-gray-500" />
        <div className="flex flex-col justify-center h-full">
          <span className="text-base text-gray-600 leading-none font-medium">
            Checkin
          </span>
          <DatePicker
            selected={checkin}
            ...
            minDate={today}
            className="text-sm font-bold outline-none h-6"
          />
        </div>
      </div>
      ...
      {/* Travellers & Rooms */}
      <div className="col-span-1 md:col-span-1 lg:col-span-2 bg-white relative border-2 border-sky-300 hover:border-red-600 text-lg rounded-md px-4 h-16 min-w-0">
        <button
      ...
      <button
        ...
        className="col-span-1 md:col-span-1 bg-red-600 text-white px-6 rounded-md hover:bg-red-700 flex items-center gap-2 cursor-pointer h-16 justify-center"
      >
    ...
    <div className="flex justify-between items-center">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="px-2 py-1 bg-red-200 rounded cursor-pointer"
        >
          -
        </button>
        ...
        <button
          ...
          className="px-2 py-1 bg-sky-200 rounded cursor-pointer"
        >
          +
        </button>
      </div>
