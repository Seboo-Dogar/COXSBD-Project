...
import { Cpu, Database, MapPin, Search } from "lucide-react";

const DedicatedServerSearchForm: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    router.push(
      `/dedicated-server/search?cpu=${encodeURIComponent(cpu)}&ram=${encodeURIComponent(ram)}&location=${encodeURIComponent(location)}`
    );
  };
...
export default DedicatedServerSearchForm;
